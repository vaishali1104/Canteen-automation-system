      ...
      <div class="leave-reply">
        <div style="width:40%; margin:auto;">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-4">
                <input type="number" name="prepTime" required> minutes
                </div>
                <div class="col-md-12 col-sm-4">
				...
				<?php
						...
						?>
						<select name="food_category" id="food_category" style="width:100%; height: 40px;">
						<option value="-1">Select Food Category</option>
						<?php
