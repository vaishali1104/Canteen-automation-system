				...
				<div class=" container">
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-12 text-center">
							<div class="category-boxes-item">
								<figure>
									<img src="img/content/desserts.png">
									<h4>Desserts</h4>
									<figcaption> <a href="#" class="btn btn-default-white"><i class="fa fa-file-text-o"></i> Read  More</a> 
									</figcaption>
								</figure>
					...
					<div class="row">
							...
							<div class="blog-latest">
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<img class="" src="img/content/blog-post-1.png" alt="blog-image">
									</div>
									<div class="col-md-6 col-sm-12">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="blog-latest">
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<img class="" src="img/content/blog-post-2.png" alt="blog-image">
									</div>
									<div class="col-md-6 col-sm-12">
										<h5><a href="#">Post Title Goes Here</a>
										</h5>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="blog-latest">
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<img class="" src="img/content/blog-post-3.png" alt="blog-image">
									</div>
									<div class="col-md-6 col-sm-12">
										<h5><a href="#">Post Title Goes Here</a>
										</h5>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="blog-latest">
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<img class="" src="img/content/blog-post-4.png" alt="blog-image">
									</div>
									<div class="col-md-6 col-sm-12">
										<h5><a href="#">Post Title Goes Here</a>
										</h5>
