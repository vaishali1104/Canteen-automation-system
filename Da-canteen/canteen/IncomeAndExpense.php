										...
										<div class="all-details">
											<div class="visible-option">
												<div class="details">
													...
													<p class="m-with-details"><strong>Description:</strong><br>Phasellus ornare, ante vitae consectetuer consequat, purus sapien ultricies dolor, et mollis pede metus eget nisi. Praesent sodales velit quis augue.</p>
													...
													<p class="for-list">5 tiger shrimps, garlic, butter, lemon, herbs, 5 tiger shrimps, garlic, butter, lemon, herbs</p>
												</div>
												...
												<div class="dropdown-details">
													<form class="default-form">
														...
														<span class="checkbox-input">
															...
															<label for="shrimps-2">Double Shrimps<i class="fa fa-plus price">$3.00</i>
															</label>
														</span>
														
														<span class="checkbox-input">
															<input type="checkbox" id="extra-veggies-2">
															<label for="extra-veggies-2">Extra Veggies <i class="fa fa-plus price">$3.00</i>
															</label>
														</span>
														
														<span class="checkbox-input">
															<input type="checkbox" id="additional-butter-2">
															<label for="additional-butter-2">Additional Butter <i class="fa fa-plus price">$3.00</i>
															</label>
														</span>
												...
												<div class="dropdown-details">
													<form class="default-form">
														...
														<span class="checkbox-input">
															...
															<label for="shrimps-3">Double Shrimps<i class="fa fa-plus price">$3.00</i>
															</label>
														</span>
														
														<span class="checkbox-input">
															<input type="checkbox" id="extra-veggies-3">
															<label for="extra-veggies-3">Extra Veggies <i class="fa fa-plus price">$3.00</i>
															</label>
														</span>
														
														<span class="checkbox-input">
															<input type="checkbox" id="additional-butter-3">
															<label for="additional-butter-3">Additional Butter <i class="fa fa-plus price">$3.00</i>
															</label>
														</span>
												...
												<div class="dropdown-details">
													<form class="default-form">
														...
														<span class="checkbox-input">
															...
															<label for="shrimps-4">Double Shrimps<i class="fa fa-plus price">$3.00</i>
															</label>
														</span>
														
														<span class="checkbox-input">
															<input type="checkbox" id="extra-veggies-4">
															<label for="extra-veggies-4">Extra Veggies <i class="fa fa-plus price">$3.00</i>
															</label>
														</span>
														
														<span class="checkbox-input">
															<input type="checkbox" id="additional-butter-4">
															<label for="additional-butter-4">Additional Butter <i class="fa fa-plus price">$3.00</i>
															</label>
														</span>
