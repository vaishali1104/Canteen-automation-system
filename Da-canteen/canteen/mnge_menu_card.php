...
<body>
	<div id="main-wrapper">
		...
		<div id="page-content">
			<div id="thumbnail-slide" style="height:30px;">
				
					<div id="thumb-slide">
						<img src="img/rahul.jpg" width="1000%" height="300rem" >
						...
						<div class="tab-content" >
							<div class="tab-pane fade in active" id="tab-1">
								<div class="all-menu-details" >
									<div>
										<h5><center>Daily Menu <a href="AddNewItem.php"><i class="fa fa-plus price" style="float:right;"></i>
										</a></center></h5>
											...
											<div class="visible-option" style="position: relative;left:-120px;width:63rem">
												...
												<div class="qty-cart text-center clearfix">
													...
													<form class="">
														...
														<br>
														<input type="button" style="width:5em;margin-top:1em" value="DELETE">
														</button>
													</form>
												</div> <!-- end .qty-cart -->
