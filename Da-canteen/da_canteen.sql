...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2019 at 08:48 PM
...
INSERT INTO `canteen_owner` (`owner_id`, `owner_name`, `canteen_name`, `phone_nu`, `password`) VALUES
(1, 'Ramesh', 'Honey Foods', 9876543210, '12345'),
(2, 'Suresh', 'Padma Kamal', 1234567890, '67890');
...
INSERT INTO `expense_category` (`ecategory_id`, `name`) VALUES
(1, 'Rent'),
(2, 'Raw materials'),
(3, 'Salary given to employees'),
(4, 'Gas Bill');
...
INSERT INTO `menu` (`menu_id`, `item_name`, `price`, `prep_time`, `food_category_id`, `owner_id`) VALUES
(1, 'Grilled Sandwich', 30, '00:10:00', 1, 2),
(2, 'Maggi', 30, '00:07:00', 1, 1),
(3, 'Cold Coffee', 25, '00:02:00', 2, 1),
(8, 'Vadapav', 20, '00:04:00', 1, 1);
...
INSERT INTO `student_info` (`student_id`, `name`, `phone_nu`, `branch_id`, `alternate_email`, `password`) VALUES
(201812038, 'Rucha Shah', 8530776249, 3, '', 'rucha123');
...
--
ALTER TABLE `expense_category`
  MODIFY `ecategory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `food_category`
--
ALTER TABLE `food_category`
  MODIFY `food_category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `student_info`
  MODIFY `student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=201812039;
