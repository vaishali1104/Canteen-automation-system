...
<header id="header">
	  ...
	  ?>
						...
						<li class="dropdown">
								<a href="login.php" class="dropdown-toggle" data-toggle="dropdown">Login/SignUp<span class="caret"></span></a>
								<ul class="dropdown-menu" role="menu">
										<li><a href="login.php">Student Login/SignUp</a></li>
										<li><a href="clogin.php">Canteen Login/SignUp</a></li>
								</ul>
						</li>
      <?php
	  }						
